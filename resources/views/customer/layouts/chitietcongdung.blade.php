    ...
    <div class="container">
        ...
        <div class="row list-group-item">
            <form method="post">
                ...
                <div class="col-sm-2 col-xs-6 check">
                    <input type="checkbox" name="checkbox" value="{{$cd->id}}" id="{{$cd->id}}">
                    <label >{{$cd->ten}}</label>
                </div>
                @endforeach
            </form>
        ...
        <div id="danhsachcon">
            ...
            <a href="chitietmonan/{{$m->id}}" class=" fooditem col-sm-3 col-xs-12">
                    ...
                    <span><i class='fa fa-comments'></i> 11 bình luận</span></span>
            </a>
            @endforeach
        </div>
    </div>
