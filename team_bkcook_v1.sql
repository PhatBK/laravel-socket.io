...
--
-- Máy chủ: 127.0.0.1
-- Thời gian đã tạo: Th3 27, 2018 lúc 03:54 PM
...
(1, 'Nhà Hàng Thập Cẩm  Phố Huế', 'nha-hang-thap-cam-pho-hue', 'phohue', '$2y$10$d9IQaq670i13u7fQVTFREuIZ4A1DRcYziXfrJ9KuCf1JzHzs0kfEO', 0, '- sdt : 0123456789\r\n- skype: phohue@outlook.com', '357 Phố Huế,Hai Bà Trưng ,Hà Nội', NULL, 'uploads/customer/avatar/z0Gp15-10ngam-nhin-bo-anh-dep-thien-nhien-moi-ngay4.jpg', 0, 'Eh5xodf2KtmcAnCm321qchU3Q7P6jDtAqTQxOfENQEGxLV85QfyeWiDeHVbt', '2017-12-06 15:43:12', '2018-03-10 10:32:35', 3, '23:10:00', '23:10:00'),
...
(1793, 'ếch xào húng quế', 'uploads/nhahang/wFGA0.jpg', 'Ếch xào húng quế với thịt ếch mềm ngọt, dai ngon, ngấm đều gia vị ướp cùng hương húng quế thơm phức hấp dẫn. Đặc biệt gia vị cay tiêu ớt thích hợp làm món ăn đúng gu cho những ngày trời lạnh.', 180000, 20000, 4, 27, 'Có', 4, '2017-12-16 12:55:30', '2018-03-25 09:19:28'),
...
(1, 'Nguyễn Huy Phát', 'Nam', 21, 'ký sư hệ thống thông tin', 'phatbk11081996@gmail.com', 'team13', '$2y$10$.qE5BWJFPt1kCuxIvy/p3eBmGiHv0uM.9v2Oek9Os2VdFI75QGTM6', 1, 47, 'uploads/customer/avatar/67v518519483_997006177069072_938937820993189642_n.png', NULL, NULL, 'iYlvaGnve0BJTmKck37gP4pCORfbQcYWnJTo39MnNwXbbOVcubC9ygRqHps7', '2017-11-30 01:44:31', '2017-11-30 01:44:31'),
...
(6, 'Bùi kim Oanh', 'Nữ', 22, 'Kỹ sư phần mềm', 'oanhvu@gmail.com', 'oanhvu', '$2y$10$43GPqwYUSJ75Nu.Sj0L2G.S0rjXtyD.tAed6AAsy43vFg7lWvWnPy', 2, 0, 'uploads/customer/avatar/qnZrecd5778fdefda4df_450082589.preview_tall.jpg', NULL, NULL, 'WonQVUnuwOsVHphqjPBmM1LDuJz9W11gQ3upYmaRoMhHfW9JRyY42TWLwIVk', '2017-12-11 15:46:13', '2018-03-24 16:38:20'),
...
--
ALTER TABLE `nguyenlieu`
  ADD CONSTRAINT `foreign key` FOREIGN KEY (`id_monan`) REFERENCES `monan` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;
