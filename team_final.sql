...
--
-- Host: 127.0.0.1
-- Generation Time: Jan 12, 2018 at 11:25 AM
...
--
-- Dumping data for table `cacbuocnau`
--
...
--
-- Dumping data for table `commentmonan`
--
...
--
-- Table structure for table `danhgiamonan`
--
...
--
-- Dumping data for table `danhgiamonan`
--
...
--
-- Table structure for table `likemonan`
--
...
CREATE TABLE `monan` (
  ...
  `nguyen_lieu_chinh` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `nguyen_lieu_phu` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
...
(42, 'Mứt vỏ bưởi xanh', '872_0.jpg', 'Tưởng chừng vỏ bưởi là thứ nguyên liệu bỏ đi nhưng chỉ cần bớt chút thời gian và công sức là bạn đã có thể biến miếng vỏ bưởi vốn the đắng trở thành những miếng mứt rất ngon và lạ miệng. Mứt vỏ bưởi khi ăn có độ dẻo và giòn, thơm thơm mùi tinh dầu rất dễ chịu. Hơn nữa, mứt vỏ bưởi lại có ưu điểm là ít ngọt hơn rất nhiều so với các loại mứt Tết', 'Vỏ bưởi tươi, 3 cái.', 'Phèn chua, 25 gr.', 'Đường trắng, 250 gr. Muối, 20 gr.', 'Dễ', 5, NULL, 11, 0, NULL, 11, 32, 16, 9, '2017-12-16 05:03:46', '2017-12-25 17:47:58'),
(44, 'Chè khúc bạch', '102_0.jpg', 'Bạn có thể biến tấu cách làm cho phong phú là thêm một ít bột trà xanh hoặc bột cacao vào khi quậy sữa tươi với whipping và đường để có thêm những màu sắc khác cho phần khúc bạch. Khi ăn, cắt khúc bạch nhỏ vừa ăn, chan vải hộp lên, rắc hạnh nhân đã nướng lên, thưởng thức. Với cách nấu chè khúc bạch siêu đơn giản tiện lợi này đảm bảo bạn sẽ có những ly chè ngon ngất ngây mà lại không mất thời gian đâu nhé!', 'Hạnh nhân, 50 gr. Kem whipping, 150 ml. Vải, 1 hũ. Sữa tươi, 400 ml.', 'Bột gelatin, 20 gr. Nước, 80 ml.', 'Đường trắng, 80 gr.', 'Dễ', 4, NULL, 7, 0, NULL, 11, 6, 16, 14, '2017-12-16 05:15:18', '2017-12-22 15:35:58'),
...
(53, 'Món ăn Truyền thống', '942_68472263-circuit-wallpapers.jpg', 'ă', 'ă', 'ă', 'ă', 'ă', 2, 2, 3, 0, NULL, 11, 27, 22, 9, '2017-12-20 07:38:17', '2018-01-10 08:28:24'),
...
(1, 'Nhà Hàng Thập Cẩm  Phố Huế', 'nha-hang-thap-cam-pho-hue', 'phohue.', '$2y$10$d9IQaq670i13u7fQVTFREuIZ4A1DRcYziXfrJ9KuCf1JzHzs0kfEO', 6, '- sdt : 0123456789\r\n- skype: phohue@outlook.com', '357 Phố Huế,Hai Bà Trưng ,Hà Nội', NULL, 'uploads/customer/avatar/z0Gp15-10ngam-nhin-bo-anh-dep-thien-nhien-moi-ngay4.jpg', 0, 'sfDM0d59fs6gMlsGdA0V4lQmivhOyXqaJboomzU0n6iIttaLm2ijS1s0IKel', '2017-12-06 15:43:12', '2018-01-09 16:40:35', 3, '23:10:00', '23:10:00'),
(2, 'Nhà Hàng Bạch Mai', 'nha-hang-bach-mai', 'bachmai.com', '$2y$10$C3W9.BpYC0AL2p9PHT8s1.6HyfhL9vIGjlayd.BLRMCwUpvPeQvb6', 13, '2222222222222222\r\n2222222222222222\r\n2222222222222222', '357 Bạch Mai,Hai Bà Trưng,Hà Nội', NULL, 'uploads/customer/avatar/nKPG68472263-circuit-wallpapers.jpg', 0, 'u3IzrOWj3dA1cuVZa6JICLfhDcmW5G4PX5SBsDgtQUXMhCWtNn2usInVPtBp', '2017-12-06 15:49:04', '2018-01-09 11:16:55', 3, '07:30:00', '21:30:00'),
(3, 'Nhà Hàng Gà 19', 'nha-hang-ga-19', 'ga19.com', '$2y$10$W.e/cjg7uuMM3qfdFzy5..FD7wvzO9qj5QMkJ9fDM7F7.Xmn9QKuW', 3, '- 357 Bạch Mai,Hai Bà Trưng Hà Nội\r\n-sdt : 0166782345\r\n-mail: bachmai@gmail.com', '402 Tôn Thất Tùng,Đống Đa,Hà Nội', NULL, 'uploads/customer/avatar/GVEe635059040-800-500.jpg', 0, 'c5XOHD3pcRaBV6ulKPZGL8JiVTTJJI7pdBpd8UnpIMBZuzwwGGJg5LfnV5lO', '2017-12-07 05:19:05', '2018-01-10 08:27:28', 3, '08:20:00', '22:50:00'),
(4, 'Nhà Hàng Cá Ba Sa Phố Huế', 'nha-hang-ca-ba-sa-pho-hue', 'cabasa.com', '$2y$10$BKMohwql5HDOroaMENRqluMsH6tjk11Ejil1ZiD5hiOqoqFGbWRl.', 6, '-sdt: 0167253635', '502 Chùa Láng', NULL, 'uploads/customer/avatar/33dG67148966-neuron-wallpapers.jpg', 0, 'Lg1d3tApOvCvYjNe0TZ5xkstd0kfzbiwrDXXK419dqtOYjNlte4q5kEKt2ha', '2017-12-07 05:20:59', '2018-01-10 04:00:13', 3, '09:25:00', '23:20:00'),
...
(6, 'Nhà Ăn Bách Khoa Hà Nội', 'nha-an-bach-khoa-ha-noi', 'bachkhoa.com', '$2y$10$EhGHueYtCUsipyozfcxaueMjJqrGkoWVBJqfzHSKQ8WteG22uMlfm', 8, '-sdt: 0988768965\r\n-phone: 0244 678 980', '15 Tạ Quang Bửu,Bách Khoa,Hai Bà Trưng ,Hà Nội', NULL, 'uploads/customer/avatar/w31kSinhVienIT.NET---resized-september-2560x1600.jpg', 0, NULL, '2017-12-16 07:57:00', '2018-01-09 14:32:46', 3, '07:00:00', '21:00:00'),
...
--
-- Table structure for table `nhahangmonan`
--
...
--
-- Dumping data for table `nhahangmonan`
--
...
(1793, 'ếch xào húng quế', 'uploads/nhahang/wFGA0.jpg', 'Ếch xào húng quế với thịt ếch mềm ngọt, dai ngon, ngấm đều gia vị ướp cùng hương húng quế thơm phức hấp dẫn. Đặc biệt gia vị cay tiêu ớt thích hợp làm món ăn đúng gu cho những ngày trời lạnh.', 180000, 20000, 4, 25, 'Có', 4, '2017-12-16 12:55:30', '2018-01-08 06:01:19'),
(3659, 'Vịt nấu giả cầy béo ngon', 'uploads/nhahang/u4Mv0.jpg', 'Vịt nấu giả cầy béo ngon với thịt vịt mềm thơm, không hôi, ngấm đều gia vị sả, mẻ, mắm tôm, ... Món vịt giả cầy này có thể giúp cả nhà ăn trong ngày lạnh thì tuyệt.', 250000, 40000, 5, 59, 'Không', 2, '2017-12-16 07:33:29', '2018-01-09 11:16:55'),
...
(4802, 'mề gà chiên', 'uploads/nhahang/3U1s0.jpg', 'Khi mề gà được, gắp ra đĩa có giấy thấm dầu, để khoảng 3 phút, sau đó cho vào đĩa. Mề gà chiên giòn cần ăn ngay cho giòn và nóng, khi ăn chấm cùng tương ớt rất ngon.', 30000, 0, 6, 9, 'Không', 6, '2017-12-17 05:11:30', '2017-12-20 08:40:30'),
(5530, 'Cá suối Bắc Giang', 'uploads/nhahang/ZQvDbchdcdhbc.jpg', 'Hôm nay ăn món này', 560000, 90000, 2, 9, 'Có', 1, '2017-12-11 16:03:29', '2018-01-09 15:56:21'),
...
(8231, 'Bà ba nấu nước dừa', 'uploads/nhahang/jfcbdevops.jpg', 'Không thể tín nổi', 1050000, 0, 6, 6, 'Không', 1, '2017-12-15 12:28:22', '2018-01-09 15:58:05'),
...
(15331, 'canh kim chi đậu hũ non', 'uploads/nhahang/i9lG0.jpg', 'Canh kim chi đậu hũ non có vị cay cay, chua chua, nóng hổi, Đây là món canh hấp dẫn, đưa cơm liên tục. Thích hợp bữa cơm những ngày lạnh, chắc chắn khiến bữa ăn thêm ấm lòng.', 30000, 0, NULL, NULL, NULL, 6, '2017-12-17 05:15:05', '2017-12-17 05:15:05'),
...
(54552, 'mì Quảng thịt gà', 'uploads/nhahang/db8Q0.jpg', 'Chỉ cần dậy sớm chút thôi bạn đã có thể nấu mì Quảng gà thơm ngon thứ thiệt để cả nhà no nê bắt đầu ngày mới rồi. Sợi mì dai dai quện với nước dùng béo ngậy, thanh ngọt vị nước dừa, cay cay của ớt rất hợp cho bữa sáng ngày đông se lạnh đấy nhé!', 35000, 0, NULL, 1, NULL, 3, '2017-12-16 12:50:42', '2017-12-16 16:44:54'),
...
(85160, 'Sườn non giả cầy', 'uploads/nhahang/mkZV0.jpg', 'Sườn non giả cầy với những miếng sườn nấu chín béo thơm, ngấm đều gia vị sả, mắm tôm, nước mắm... vị ngon đậm đà đưa cơm số dách. Thích cho những bữa cơm trời lạnh.', 250000, 10000, NULL, 2, NULL, 2, '2017-12-16 07:32:39', '2018-01-06 13:55:59'),
...
(1, 'Nguyễn Huy Phát', 'Nam', 21, 'ký sư hệ thống thông tin', 'phatbk11081996@gmail.com', 'team13', '$2y$10$.qE5BWJFPt1kCuxIvy/p3eBmGiHv0uM.9v2Oek9Os2VdFI75QGTM6', 1, 47, 'uploads/customer/avatar/67v518519483_997006177069072_938937820993189642_n.png', NULL, NULL, 'qTAxrgVMmlenKw7hhuHkYbHXWZthrJ9q8WmxFf9U0jkyjqp3cQsyk9cmPc5Y', '2017-11-30 01:44:31', '2017-11-30 01:44:31'),
(4, 'Đồ án 3', 'Nam', 21, 'kỹ sư hệ thống', 'team13@gmail.com', 'team131', '$2y$10$qGpU/bLpPSkxX/foqTtCT.OrVEPv4bJd4fHdVrLNYLucmZXPOP.Wa', 0, 1575, 'uploads/customer/avatar/TY6J2788-07-01-2017-9-09-19.jpg', NULL, NULL, 'u6uWNMS9pHkYGGueqUN2tybl8487xl4qXW36bLqtuj22i3lOx5uoOfxnRgoU', '2017-12-06 15:59:57', '2017-12-06 15:59:57'),
...
(6, 'Bùi kim Oanh', 'Nữ', 21, 'vô gia cư', 'oanhvu@gmail.com', 'oanhvu', '$2y$10$43GPqwYUSJ75Nu.Sj0L2G.S0rjXtyD.tAed6AAsy43vFg7lWvWnPy', 2, 0, 'uploads/customer/avatar/bHGkIMG_20171101_135322.jpg', NULL, NULL, 'WonQVUnuwOsVHphqjPBmM1LDuJz9W11gQ3upYmaRoMhHfW9JRyY42TWLwIVk', '2017-12-11 15:46:13', '2017-12-11 15:46:13'),
...
(26, 'Nguyễn Huy Phát', 'Nam', 21, 'Development', 'phatsn11081996@gmail.com', 'phatbk', '$2y$10$OCUVpCxxWo3kE4F/mqOpj.5HY8newcrEl06IREadGgQAGEa2cqV/q', 0, NULL, 'uploads/customer/avatar/Aj4gFB_20160713_23_08_53_Saved_Picture.jpg', NULL, NULL, 'fzYKOrbojPhROZyrdOnqCe34uUanVv03OnpfSPTk6L2sodqkFgPhbr5PCPkK', '2017-12-18 19:53:40', '2017-12-18 19:53:40'),
(27, 'Hoàng Văn Hậu', 'Không Xác Định', 21, 'sinh viên', 'hauhoang@gmail.com', 'hauhoang', '$2y$10$05luSiT9OtQQIZ6DvrI1YuRQzRMWB2wYPKPKugYP.Pnm31jdO1Lg6', 2, 58, 'uploads/customer/avatar/Qsng17426226_1324075811019127_1515828002267935521_n.jpg', NULL, NULL, 'z58tdgXGQX2w727Oe03Hlu7Y7m5MwOb7B5EysRPnoa5cQznkaxAHqDxsEe9X', '2017-12-19 11:58:24', '2017-12-19 11:58:24'),
(28, 'Nguyễn Thu Hà San', 'Nữ', 21, 'không biết', 'hanguyen@gmail.com', 'hasan', '$2y$10$npl/DkbUmdGlRR0SvtCM5Or7sd63JxLNqKk3bvoZjq/j7HqpAYbpW', 2, 8, 'uploads/customer/avatar/09n0DBSNKF0XoAATrjh.jpg', NULL, NULL, 'ROrYlja6cQIwKoURY7VEx0CArYdr7l0OmpBnVrmPK0XJ0YKJ6Dgiww9Xll25', '2017-12-19 12:54:25', '2017-12-19 12:54:25'),
...
--
-- Indexes for table `danhgiamonan`
--
...
--
-- Indexes for table `nhahangmonan`
--
...
--
-- AUTO_INCREMENT for table `danhgiamonan`
--
ALTER TABLE `danhgiamonan`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=128;
--
-- AUTO_INCREMENT for table `likemonan`
--
ALTER TABLE `likemonan`
...
--
-- Constraints for table `danhgiamonan`
--
ALTER TABLE `danhgiamonan`
...
--
-- Constraints for table `likemonan`
--
ALTER TABLE `likemonan`
...
--
-- Constraints for table `nhahangmonan`
--
ALTER TABLE `nhahangmonan`
