...
<head>
    ...
    <title>Nhà Hàng Liên Kết Login</title>
            ...
            <div class="col-md-4 col-md-offset-4">
                <div class="login-panel panel panel-default">
                    <div class="panel-heading">
                        <h3 class="panel-title" align="center">Nhà Hàng Liên Kết</h3>
                    </div>
                    <div class="panel-body">
                        <form role="form" action="<?php echo e(route('nhahang.login.submit')); ?>" method="POST">
                        ...
                        <br>
                        <div class="form-group">
                            <a class="btn btn-lg btn-warning btn-block" href="<?php echo e(route('trangchu')); ?>">Trở Về Trang Chủ</a>
                        </div>
                    </div>
                </div>
            </div>
