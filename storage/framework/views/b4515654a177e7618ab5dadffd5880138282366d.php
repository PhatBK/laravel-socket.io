        ...
        <div class="row list-group-item">
            <form method="post">
                ...
                <div class="col-sm-3 col-xs-6 check">
                    <input type="checkbox" name="checkbox" value="<?php echo e($md->id); ?>" id="<?php echo e($md->id); ?>">
                    <label for="<?php echo e($md->id); ?>" ><?php echo e($md->ten); ?></label>
                </div>
...
<script type="text/javascript">
    $(document).ready(function(){
       ...
       $( "input" ).on( "click", function() {
            ...
            var url="<?php echo e(route('monan_mucdich')); ?>";
            console.log(url);
            $.ajax({
                type: "POST",
                url: url,
