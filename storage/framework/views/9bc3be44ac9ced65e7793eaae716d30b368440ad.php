...
<section id="theloai" class="theloai">
    <div class="container">
        <h3 class="text-success text-center">Thể loại</h3>
        <div class="row">

            <a href="#" class="fooditem col-sm-3 col-xs-12">
                <h5 class="tieude">Khai vị</h5>
                <img src="https://media.cooky.vn/recipe/g2/19494/s320/recipe19494-636274205695226444.jpg" alt="">
            ...
            <a href="#" class="fooditem col-sm-3 col-xs-12">
                <h5 class="tieude">Món chay</h5>
                <img src="https://media.cooky.vn/recipe/g2/19009/s320/recipe19009-636231824356818385.jpg" alt="">
            ...
            <a href="#" class="fooditem col-sm-3 col-xs-12">
                <h5 class="tieude">Món chính</h5>
                <img src="https://media.cooky.vn/recipe/g2/19886/s320/recipe19886-636296080044257040.jpg" alt="">
            ...
            <a href="#" class="fooditem col-sm-3 col-xs-12">
                <h5 class="tieude">Ăn vặt</h5>
                <img src="https://media.cooky.vn/recipe/g3/20259/s320/recipe20259-636322627940948264.jpg" alt="">
                <p class="mota">Lẩu, là món ăn lỏng như canh kiểu Âu, được làm bằng nhiều nguyên liệu kết hợp với nhau như thịt, cá và rau, đậu, trái cây, nước hoặc các chất lỏng khác, có thêm gia vị, thường ăn vào đầu bữa cơm kiểu Âu như một món khai vị hay bữa điểm tâm.</p>
                <span class="thechia"></span>
                <span class="social">
                    <span><i class="fa fa-cutlery"></i> 17 món ăn</span>
