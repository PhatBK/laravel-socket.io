 <nav class="navbar navbar-default navbar-static-top" role="navigation" style="margin-bottom: 0">
            ...
            <div class="navbar-header">
                ...
                <div class="alert-warning">
                    <a class="navbar-brand" href="admin/info-page-admin">Ẩm Thực Quanh Ta</a>
                </div>
            </div>
            <!-- /.navbar-header -->
            ...
            <ul class="nav navbar-top-links navbar-right">
                ...
                <li class="dropdown" title="Thông Báo">
                 ...
                 <!-- /.dropdown -->
                <li class="dropdown" title="Online : <?php echo e(Auth::user()->tentaikhoan); ?>">
                    <a class="dropdown-toggle" data-toggle="dropdown" href="#">
                    ...
                    <ul class="dropdown-menu dropdown-user">
                        ...
                        <li><a href="admin/user/sua/<?php echo e(Auth::user()->id); ?>/<?php echo e(Auth::user()->tentaikhoan); ?>"><i class="fa fa-gear fa-fw">::</i>Cài Đặt</a>
                        </li>
                        <li class="divider"></li>
